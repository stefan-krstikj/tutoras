package com.mk.ukim.finki.winterstore.jwt;
...
public class JwtTokenUtil implements Serializable {
    ...
    private String secret = "asdsadasjhdajkshfgajhsgfhjkas12jkashfdkjahsfkjhask";
    ...
    public String getRoleFromToken(String token){
        ...
        String authorities = (String) parsedToken.getBody()
                .get("ROLE");
